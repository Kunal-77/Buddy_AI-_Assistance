# For running this file you need to give your request in imageGenration.data file and give command like "Iron Man,True"
import asyncio
...
while True:
    try:
        ...
        with open(r"D:\Buddy_AI\Frontend\Files\ImageGeneration.data", "r") as f:
            Data: str = f.read()
        ...
        if Status == "True":
            ...
            with open(r"D:\Buddy_AI\Frontend\Files\ImageGeneration.data", "w") as f:
                f.write("False,False")
